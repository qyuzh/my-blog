...
export default defineConfig({
  ...
  lang: 'en-US',
  title: 'qyuzh',
  description: "qyuzh's personal space",
  cleanUrls: true,
  lastUpdated: true,
  markdown: {
    lineNumbers: true,
  ...
  themeConfig: {
    ...
    nav: [
      ...
      { text: 'JavaScript', link: '/js/' },
      {
        ...
        items: [
          {
            text: 'Classic Methods',
            link: '/algorithm/classic-methods/',
          },
          {
            text: 'LeetCode',
    ...
    socialLinks: [
      { icon: 'github', link: 'https://github.com/qyuzh/' },
      {
        icon: {
